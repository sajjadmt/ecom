                                ...
                                <Row>
                                    ...
                                    <Col className="p-3" md={6} lg={6} sm={12} xs={12}>
                                        ...
                                        <div className={colorDiv}>
                                            ...
                                            <select onChange={(e)=>{this.setState({color:e.target.value})}} className="form-control dorm-select">
                                        ...
                                        <div className={sizeDiv}>
                                            ...
                                            <select onChange={(e)=>{this.setState({size:e.target.value})}} className="form-control dorm-select">
